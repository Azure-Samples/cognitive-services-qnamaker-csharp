...
namespace Microsoft.Bot.Sample.LuisBot
{
    ...
    public class BasicLuisDialog : LuisDialog<object>
    {
        ...
        static string LUIS_apiKey = "<LUIS-endpoint-or-starter-key>";
        static string LUIS_hostRegion = "westus.api.cognitive.microsoft.com";

        // QnA Maker global settings
        // assumes all KBs are created with same Azure service
        static string qnamaker_endpointKey = "<qna-maker-subscription-key>";
        static string qnamaker_endpointDomain = "<web-app-bot-name>";
        
        // QnA Maker Human Resources Knowledge base
        static string HR_kbID = "<qna-maker-hr-knowledge-base-id>";

        // QnA Maker Finance Knowledge base
        static string Finance_kbID = "<qna-maker-finance-knowledge-base-id>";
